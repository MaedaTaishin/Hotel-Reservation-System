...
public class RoomException extends Exception {
	...
	private static final String MESSAGE_AVAILABLE_QTY_OUT_OF_BOUNDS = "All rooms of the selected type are fully booked for the selected date";

	private static final String MESSAGE_EMPTYROOM_NOT_FOUND = "No available rooms found for check-in";
